...
def get_training_health():
    ...
    df1 = pd.read_csv("../data/training/COVID-FNIR-True.csv")[['Text', 'Binary Label']]  # Covid-FNIR
    df2 = pd.read_csv("../data/training/COVID-FNIR-Fake.csv")[['Text', 'Binary Label']] #Covid-FNIR
    df3 = pd.read_excel("../data/training/COVID-FN.xlsx")[['text', 'label']]
    # Renaming columns
...
def get_training_politics():
    ...
    df1 = pd.read_csv("../data/training/FakeNews.csv")[['title', 'text', 'label']] #FakeNews
...
def get_training_social():
    # Reading the two datasets and only extracting the useful columns
    df1 = pd.read_csv("../data/training/GossipCop_True.csv")[['title']]
    df2 = pd.read_csv("../data/training/GossipCop_Fake.csv")[['title']]
    # Adding an 'is_true' column
    df1['is_true'] = 1
    df2['is_true'] = 0
    # Combining the dataframes
...
def get_testing_crime():
    # Reading the dataset and only extracting the useful columns
    df = pd.read_csv("../data/training/Snopes.csv")
...
def get_testing_health():
    # Reading the two datasets and only extracting the useful columns
    df1 = pd.read_csv("../data/testing/COVID_Claims_True.csv")[['Text', 'Label']]
    df2 = pd.read_csv("../data/testing/COVID_Claims_Fake.csv")[['Text', 'Binary Label']]
